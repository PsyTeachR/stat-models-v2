...
#| fig.cap: "*Effect of sonic distraction on simple RT, urban group.*"
#| message: false
...
#| fig.cap: "*Effect of sonic distraction on simple RT for urban and rural participants.*"
...
- $\hat{\beta_0}$ = `{r} sprintf("%0.3f", coef(sonic_mod)[1])`
- $\hat{\beta_1}$ = `{r} sprintf("%0.3f", coef(sonic_mod)[2])`
- $\hat{\beta_2}$ = `{r} sprintf("%0.3f", coef(sonic_mod)[3])`
- $\hat{\beta_3}$ = `{r} sprintf("%0.3f", coef(sonic_mod)[4])`
...
$Y_i =$ `{r} sprintf("%0.3f", coef(sonic_mod)[1])` $+$ `{r} sprintf("%0.3f", coef(sonic_mod)[2])` $X_{1i}$
...
$Y_i =$ `{r} sprintf("%0.3f", coef(sonic_mod)[1] + coef(sonic_mod)[3])` $+$ `{r} sprintf("%0.3f", coef(sonic_mod)[2] + coef(sonic_mod)[4])` $X_{1i}$
...
```{r}
#| label: tbl-full-factorial-2x2-c1
#| echo: false
#| tbl-cap: "$C_1$"
#| html-table-processing: none
...
```{r}
#| label: tbl-full-factorial-2x2-c2
#| echo: false
#| tbl-cap: "$C_2$"
#| html-table-processing: none
...
```{r}
#| label: fig-cogdata
#| fig.cap: "The effect of music genre and volume on cognitive performance."
#| fig.width: 5
#| fig.height: 5
#| fig.asp: .7
#| echo: false
...
![](img/04-interactions_factorial_app.png)
...
```{r}
#| label: tbl-coding-schemes
#| echo: false
#| tbl-cap: "codes for a two-level factor"
#| html-table-processing: none
